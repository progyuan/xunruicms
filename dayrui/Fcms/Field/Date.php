...
class Date extends \Phpcmf\Library\A_Field {
    ...
    public function input($field, $value = 0) {
        ...
        // 表单宽度设置
        $width = \Phpcmf\Service::IS_MOBILE() ? '100%' : ($field['setting']['option']['width'] ? $field['setting']['option']['width'] : 200);
        ...
        APP_DIR && $name == 'updatetime' && $str.= '<label><input name="no_time" checked type="checkbox" value="1" /> '.dr_lang('不更新').'</label>';
