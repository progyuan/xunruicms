...
class Seo_content extends \Phpcmf\Common
{
    ...
    public function show_index() {
        ...
        \Phpcmf\Service::V()->display('seo_content.html');
    }
    ...
    public function edit() {
        ...
        if (IS_AJAX_POST) {
            ...
            foreach (['html', 'urlrule', 'show_title', 'show_keywords', 'show_description'] as $name) {
